...
def good_run(days_ago=45):
    # Relatief aan de echte klok, niet aan NOW: de poort rekent met
    # datetime.now(). Met een vaste datum was "drie dagen geleden" na een
    # maand ineens "vierendertig dagen geleden", en faalde deze test op een
    # dag waarop er niets aan de code was veranderd.
    return {
